...
public class WdrcLineChart extends LineChart implements OnChartGestureListener, OnChartValueSelectedListener {

    private static final String TAG =WdrcLineChart.class.getSimpleName();;
    ...
    public WdrcLineChart(Context context) {
        super(context);
        initSingleTapLineChart();
    }

    public WdrcLineChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        initSingleTapLineChart();
    }

    public WdrcLineChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void changeTouchEntry() {
        ...
        //iEntry =0，1，2 分别对应小声，正常声，大声， 正常声(ientry=1)不调增益
        if (iEntry ==1)   {
            return;
        }
