package com.jhearing.e7160sl.Im;
...
public class JWebSocketClientService extends Service {
    ...
    private final static int GRAY_SERVICE_ID = 1101;
    //灰色保活
    ...
    private void initSocketClient() {
        ...
        URI uri = URI.create("ws://47.101.217.19:8001/mobroom"+ Configuration.instance().serial_uuid);
